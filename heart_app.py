...
kmeans = joblib.load("kmeans.jb")

# Define input fields for patient symptoms
st.title("🚑 Triage Prediction System")
...
if st.button("Predict Triage Level"):
    ...
    st.subheader(f"Triage Priority: {result}")
...
get_ipython().system('jupyter nbconvert --to script heart_app.ipynb')
